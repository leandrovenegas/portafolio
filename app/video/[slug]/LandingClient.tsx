  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          Sacale el provecho a {' '}
          <span style={{ color: 'var(--color-muted)' }}>tus reseñas de google maps</span>
        </h2>
      </section>
    ...
    <li key={i} style={{
      ...
      <span>{item}</span>
          ...
          >
            ...
            <p style={{ color: 'var(--color-ink)', fontSize: '14px', lineHeight: '1.55' }}>
          ...
          >
            ...
            <p style={{ color: 'var(--color-muted)', fontSize: '14px', lineHeight: '1.55' }}>
              8 reseñas repartidas en 2 videos de 30s + voz off whisper/IA.
            </p>
          </div>
        </div>
        ...
        <button
          ...
          onClick={() =>
            handleWspClick(
              'personalized',
              `Hola Leandro, vi el video de ${business_name} y quiero cotizar una versión pagada.`
            )
          }
          style={{
