...
export default function FormatsSection({
  ...
  return (
    <section className="w-full py-16 md:py-24 grid grid-cols-1 gap-12 md:gap-16">
      {title && (
        <div className="col-span-1 max-w-4xl mx-auto text-center px-4">
          <h2 
            data-field="title"
      ...
      <div className="col-span-1 grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 max-w-6xl mx-auto w-full px-4">
        {items.map((fmt) => (
          <div
            key={fmt.id || fmt.title}
            className="col-span-1 flex flex-col gap-6 p-8 rounded-2xl border border-border/20 bg-[#0A0A0A]/50 transition-all duration-300 hover:border-accent/20 hover:bg-[#0F0F0F]"
          >
