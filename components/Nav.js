  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-6 md:px-10 flex items-center justify-between">
        ...
        {/* Mobile Overlay Menu */}
        <div 
          className={`fixed inset-0 bg-black/98 backdrop-blur-2xl flex flex-col items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.23, 1, 0.32, 1)] md:hidden z-[105] ${
